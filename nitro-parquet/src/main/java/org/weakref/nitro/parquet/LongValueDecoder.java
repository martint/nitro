...
/** Physical decoder whose logical carrier is a signed long. */
interface LongValueDecoder
        extends PhysicalValueDecoder
{
    long value(int ordinal, int dictionaryId);

    default void copyPlain(int ordinal, long[] output, int outputOffset, int count)
    {
