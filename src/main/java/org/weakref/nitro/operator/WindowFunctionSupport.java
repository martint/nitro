...
/**
 * Shared helpers for {@link RunningWindowFunction} implementations.
 */
final class WindowFunctionSupport
{
    private WindowFunctionSupport() {}

    static WritableNulls writableOutputNulls(Allocator allocator, Allocator.Context allocationContext, Streams output)
    {
    ...
    record WritableNulls(Streams output, BooleanVector nulls) {}
}
