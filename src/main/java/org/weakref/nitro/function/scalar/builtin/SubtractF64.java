...
@ScalarFunction(name = "subtract_f64", capabilities = SubtractF64Optimization.class)
public final class SubtractF64
        implements PrimitiveFunction
{
    ...
    {
        checkArgument(inputs.size() == 2, "Unexpected argument count for subtract_f64");
        ...
        // Monomorphic, encoding-specialized kernels: decide the operand shapes once, then run a tight typed
        // loop (the all-selected case auto-vectorizes). Only the rare general case falls back to the
        // megamorphic per-element DoubleValues accessor.
