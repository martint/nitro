...
{
    private static final Allocator.Context ALLOCATION_CONTEXT = new Allocator.Context("ModuloI64");
    private static final Allocator.Context ERRORS_CONTEXT = new Allocator.Context("ModuloI64.errors");
    ...
    public Streams apply(List<Streams> inputs, Mask mask, Set<Stream> requestedStreams, Streams output, PrimitiveExecutionContext context)
    {
        ...
        if (left instanceof RleVector leftRle && right instanceof RleVector rightRle && mask.all() && existingValues == null && existingErrors == null) {
            ...
            if (requestErrors) {
                return Streams.of(Stream.ERRORS, I64BinaryDispatch.rleRleErrorsOnly(leftRle, rightRle, ModuloI64::apply));
            }
            if (requestValues) {
                return Streams.ofValues(I64BinaryDispatch.rleRleLong(leftRle, rightRle, ModuloI64::result));
            }
