...
/**
 * Registry-owned projection lowering for a UTF-8 conditional.
 */
public final class IfUtf8Optimization
    ...
    public Optional<ProjectionProgram> generate(ProjectionCodeBuilder builder, List<ProjectionArgument> arguments)
    {
        ...
        return Optional.of(builder.program(
                List.of(
                        ...
                        ProjectionCodeBuilder.ValueType.UTF8,
                        ProjectionCodeBuilder.ValueType.UTF8),
                builder.conditional(
                        condition,
                        builder.argument(1, ProjectionCodeBuilder.ValueType.UTF8),
                        builder.argument(2, ProjectionCodeBuilder.ValueType.UTF8)),
