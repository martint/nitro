...
@ScalarFunction(name = "divide_scale_round_i64")
public final class DivideScaleRoundI64
        implements PrimitiveFunction
{
    ...
    {
        checkArgument(inputs.size() == 3, "Unexpected argument count for divide_scale_round_i64");
        ...
        Allocator.Context allocationContext = context.allocationContext("DivideScaleRoundI64");
