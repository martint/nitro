...
public final class AddI64Primitive
        implements PrimitiveFunction
{
    private static final Allocator.Context ALLOCATION_CONTEXT = new Allocator.Context("AddI64Primitive");

    public AddI64Primitive() {}

    public AddI64Primitive(ScalarDescriptor descriptor)
    {
    ...
    {
        GeneratedPrimitiveSupport.verifyBinaryArity("add", inputs.size());
        return Streams.ofValues(I64BinaryVectorSupport.applyLongBinary(
                "add",
                inputs.get(0).values(),
                inputs.get(1).values(),
                mask,
