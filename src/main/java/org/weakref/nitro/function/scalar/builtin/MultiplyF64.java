...
@ScalarFunction(name = "multiply_f64", capabilities = MultiplyF64Optimization.class)
public final class MultiplyF64
        implements PrimitiveFunction
{
    ...
    {
        checkArgument(inputs.size() == 2, "Unexpected argument count for multiply_f64");
