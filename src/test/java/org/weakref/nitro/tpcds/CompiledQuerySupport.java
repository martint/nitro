...
public final class CompiledQuerySupport
{
    ...
    private static Operator scan(Allocator allocator, ParquetTables tables, String table, String... columns)
    {
        ...
        return new MultiStageOperator(
                ...
                path -> new NitroParquetScanOperator(NitroParquetScanResources.createDefault(), allocator, List.of(path), List.of(columns)));
    }
            ...
            org.weakref.nitro.legacy.pipeline.QueryLowering.Lowered lowered, java.util.Map<String, Materialized> virtuals)
    {
        ...
        org.weakref.nitro.legacy.pipeline.StreamingPipeline.Source source = usePageSource(probe, lowered)
