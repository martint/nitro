...
@ScalarFunction(name = "rounded_bigint_ratio")
public final class RoundedBigintRatio
        implements PrimitiveFunction
{
    ...
    {
        checkArgument(inputs.size() == 2, "Unexpected argument count for rounded_bigint_ratio");
        ...
        Allocator.Context allocationContext = context.allocationContext("RoundedBigintRatio");
