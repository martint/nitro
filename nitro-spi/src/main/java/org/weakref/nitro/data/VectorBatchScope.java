...
/// Reusable allocator ownership scope for one live vector-batch generation.
///
/// This component owns transfer and release semantics only. Source and
/// execution facades build their own generation-specific batch and column
/// views over it.
public final class VectorBatchScope
        implements AutoCloseable, BatchBufferOwner
{
    ...
    public VectorBatchScope(Allocator allocator, String name)
    {
    ...
    public VectorBatchScope(Allocator allocator, String name, Object poolGroup)
    {
        this(allocator, new Allocator.Context(
                requireNonNull(name, "name is null"),
                requireNonNull(poolGroup, "poolGroup is null")));
    }

    public VectorBatchScope(Allocator allocator, Allocator.Context context)
    {
