...
/** Elapsed phase timings accumulated by a host-scheduled aggregation session. */
public record AggregationPhaseMetrics(
        long fusedNanos,
        long groupingNanos,
        long statePreparationNanos,
        long accumulationNanos,
