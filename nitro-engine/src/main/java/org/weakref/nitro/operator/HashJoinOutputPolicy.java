...
public record HashJoinOutputPolicy(
        ...
        boolean aliasBatchDictionaryIds,
        boolean aliasFullBatchDictionaryIds,
        ...
        boolean poolBuildDictionaryIds)
{
    ...
    public static HashJoinOutputPolicy fromSystemProperties()
    {
        ...
        return new HashJoinOutputPolicy(
                ...
                booleanProperty("nitro.hash.join.aliasBatchDictionaryIds", defaults.aliasBatchDictionaryIds()),
                booleanProperty("nitro.hash.join.aliasFullBatchDictionaryIds", defaults.aliasFullBatchDictionaryIds()),
