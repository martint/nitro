        ...
        boolean debugJoinIndex)
{
    ...
    public static HashJoinIndexPolicy fromSystemProperties()
    {
        ...
        return new HashJoinIndexPolicy(
                ...
                booleanProperty("nitro.join.directRangeBuild", defaults.directRangeBuild()),
                Integer.getInteger(
                        "nitro.join.directRangeBuildMinRows",
                        defaults.directRangeBuildMinRows()),
