...
/**
 * Registry-owned projection lowering for an F64 conditional.
 */
public final class IfF64Optimization
    ...
    public Optional<ProjectionProgram> generate(ProjectionCodeBuilder builder, List<ProjectionArgument> arguments)
    {
        ...
        return Optional.of(builder.program(
                List.of(
                        ...
                        ProjectionCodeBuilder.ValueType.F64,
                        ProjectionCodeBuilder.ValueType.F64),
                builder.conditional(
                        condition,
                        builder.argument(1, ProjectionCodeBuilder.ValueType.F64),
                        builder.argument(2, ProjectionCodeBuilder.ValueType.F64)),
